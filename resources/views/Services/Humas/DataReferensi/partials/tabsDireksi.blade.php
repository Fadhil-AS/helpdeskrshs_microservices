<div class="container mt-5">
    <div class="custom-tab p-1">
        <ul class="nav nav-tabs w-100 border-0" role="tablist">
            ...
            <li class="nav-item" role="presentation" style="flex: 1;">
                <a class="nav-link fw-semibold text-center fw-semibold" id="tab-penyelesaian-tab" data-bs-toggle="tab"
                    href="#tab-penyelesaian" role="tab" aria-controls="tab-penyelesaian" aria-selected="false">
