<div class="modal fade" id="modalTambahDireksi" tabindex="-1" aria-labelledby="modalTambahDireksiLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('humas.direksi-humas.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nama Direksi</label>
                        <input type="text" class="form-control" placeholder="Masukkan nama direksi" name="nama">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nomor Telepon</label>
                        <input type="text" class="form-control" placeholder="Masukkan nomor telepon" name="no_tlpn">
                        <small class="text-muted">Masukkan nomor WhatsApp yang aktif untuk notifikasi</small>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Keterangan</label>
                        <input type="text" class="form-control"
                            placeholder="Masukkan keterangan (contoh: dirut, dirmed)" name="ket">
